...
def main():
    ...
    # since no manual labels are available for this specific video.
    ...
    # Automatically define slots based on the first frame detections
    ...
    frame_count = 0
    MAX_FRAMES = 200  # Evaluate on a sufficient number of frames
    ...
    while frame_count < MAX_FRAMES:
        ...
        for i, status in enumerate(slot_status):
            ...
            if is_occupied != smoothed_states[i]:
                # Only count flip if history is full enough to be stable
